"""
Django settings for hidden_rain_dev_110818 project.
...
ROOT_URLCONF = 'hidden_rain_dev_110818.urls'
...
WSGI_APPLICATION = 'hidden_rain_dev_110818.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_rain_dev_110818 API",
    "DESCRIPTION": "API documentation for hidden_rain_dev_110818 App",
    "VERSION": "v1",
}
